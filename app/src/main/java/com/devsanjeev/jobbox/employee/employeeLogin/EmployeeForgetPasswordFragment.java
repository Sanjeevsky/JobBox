...
public class EmployeeForgetPasswordFragment extends Fragment {
    ...
    public EmployeeForgetPasswordFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_employee_forget_password, container, false);
        sendOtpLayout=view.findViewById(R.id.employee_send_otp_layout);
        enterPasswordLayout=view.findViewById(R.id.employee_enter_otp_layout);
        OTPEditText=view.findViewById(R.id.employee_forget_otp);
        Password=view.findViewById(R.id.employee_forget_password);
        ConfirmPassword=view.findViewById(R.id.employee_forget_confirm_password);
        Email=view.findViewById(R.id.employee_forget_email);
        SendOtp=view.findViewById(R.id.employee_forget_send_otp_btn);
        Submit=view.findViewById(R.id.employee_forget_submit_btn);
    ...
    private void submitPassword() {
        ...
        if(!email.isEmpty()&&!otp.isEmpty()&&!password.isEmpty()&&!confirmPassword.isEmpty()){
            if(password.equals(confirmPassword)){
                ...
                Call<ConfirmPasswordResponse> confirmPasswordResponseCall=apiInterface.updateEmployeePassword(request);
...
// Replace the contents of the container with the new fragment
    ...
    private void doSendOTP() {
        ...
        if(!email.isEmpty()){
            ...
            request.setEmail(email);
            Call<ForgetPasswordResponse> call=apiInterface.sentMailEmployee(request);
